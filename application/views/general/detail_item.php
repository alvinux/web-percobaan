	...
	<div class="row">
		<aside class="col-sm-3 col-sm-push-9">
			<div class="widget detail">
				<h3 class="topkosong">Detail penjual dan etalase</h3>
			</div><!--/.detail-->
		...
		<div class="col-sm-9 col-sm-pull-3"><!--content produk-->
			...
			<div class="col-sm-6"><!----Detail produk-------->
				<form action="#" method="post" accept-charset="utf-8">            
					<div class="sum-item">	
						<p class="bold"><span class="row col-md-3">Stok</span> : <span>Kosong</span></p>
						<p class="bold"><span class="row col-md-3">Berat</span> : <span>2 Gram</span></p>
						<p class="bold"><span class="row col-md-3">Diskon</span> : <span>10 %</span></p>
					...
					<input name="harga" value="900000" type="hidden"><!-- harga setelah diskon -->
					<input name="id_barang" value="13" type="hidden"><!-- id barang -->
					<div class="mg-b-20">
						<button type="submit" class="btn btn-primary btn-lg btn-block bold"><span class="glyphicon glyphicon-shopping-cart"></span> Beli</button>
					</div>
				</form>
			</div><!--detail produk--->
					...
					<div class="media">
						...
						<div id="comments">
							<div id="comments-list">
								...
								<div class="media">
									<div class="pull-left">
										<img class="avatar img-circle" src="<?php echo base_url() ?>doc/themes/public/images/blog/avatar1.png" alt="">
									</div>
									<div class="media-body">
										<div class="well">
											<div class="media-heading">
										...
										<div class="media">
											<div class="pull-left">
												<img class="avatar img-circle" src="<?php echo base_url() ?>doc/themes/public/images/blog/avatar3.png" alt="">
											</div>
											<div class="media-body">
												<div class="well">
													<div class="media-heading">
								...
								<div class="media">
									<div class="pull-left">
										<img class="avatar img-circle" src="<?php echo base_url() ?>doc/themes/public/images/blog/avatar2.png" alt="">
									</div>
									<div class="media-body">
										<div class="well">
											<div class="media-heading">
