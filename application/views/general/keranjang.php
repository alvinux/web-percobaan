	...
	<div class="row container">
		...
		<div class="span12">
						...
						<td colspan="8">
							<span class="pull-left mt-5">
								...
								<b>Pembelian dari toko:
									<a class="ml-5" href="https://www.tokopedia.com/sovenirzone">Sovenir Zone</a>
								</b>
							</span>
				...
				<tbody>
					<tr id="detail_cart-22432741" class="cart-item ">
						<td colspan="2">
							<span class="pull-left" style="padding-right: 10px;">
								<img class="pull-left mr-10" src="<?php echo base_url('doc/themes/public/img/produk/thumbnail-1.jpg'); ?>" alt="Timbangan Badan Dari Kaca (bentuk kotak)" width="70">
							</span>
							<span class="pull-left w-300">
								<a class="pull-left product-name" href="#">
									<b>Timbangan Badan Dari Kaca (bentuk kotak)</b>
								</a>
								<span class="pull-left clear-b">
									<small><b>1 Barang (1.6 kg)</b> x  Rp 110.000,-</small>
								</span>
								<span class="pull-left clear-b">
						...
						<td>
							...
							<span class="pull-left clear-b">Rp 110.000,-</span>
						</td>
						<td colspan="2">
					...
					<tr class="transaction-detail-bottom">
						<td class="span7">
							...
							<p>
								<strong>Alvin Indra Cahya</strong>
								<br>Jln. Bintara 17, RT.08 / RW.02, No.06 Kel.Bintara Jaya, Kec.Bekasi Barat
								<br>(Belakang SMPN 22 Bekasi)
								<br>Bekasi Barat Kota Bekasi, 17136
								<br>Jawa Barat
								<br>Telp: 085717617053
							</p>
						</td>
						...
						-->
						<td class="span3">
							<p><b>Total Barang</b>  <br><span>1  (1.6 kg)</span></p>
						</td>

						<td class="col-md3">
							<b>Subtotal</b> <p><span>Rp 110.000,-</span></p>
						</td>

						<td class="span3"><b>Biaya Asuransi</b><p><span>Rp 0,-</span></p></td>

						<td class="span3"><b>Ongkos Kirim</b><p> <span>Rp 34.000,-</span></p></td>
				...
				<tfoot>
					<tr>
						<td colspan="6">
							...
							<span class="pull-right item-total">Total <b>Rp 144.000,-</b></span>
			...
			<div class="pull-right">
					<a href="#myModal" role="button" class="btn btn-large btn-primary" data-toggle="modal">Lanjutkan</a>
			</div>
		</div>
	</div>
</section>
